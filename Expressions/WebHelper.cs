...
namespace BPMC.Common.Expressions
{
    public class WebHelper
    {
        ...
        public static string SerializeGroupToJSON(Group g)
        {
            ...
            if (g.Rules != null && g.Rules.Count > 0)
            {
                ...
                for (int i = 0; i < g.Rules.Count; i++)
                {
                    ...
                    switch (r.Operator)
                    {
                        case RuleOperator.Contains: opString = "multipleSelect"; break;
                        case RuleOperator.EndsWith: opString = "ew"; break;
                        case RuleOperator.Equals: opString = "equal"; break;
                        case RuleOperator.GraterOrEqual: opString = "ge"; break;
                        case RuleOperator.GraterThan: opString = "more"; break;
                        case RuleOperator.IsNull: opString = "nu"; break;
                        case RuleOperator.LessOrEqual: opString = "le"; break;
                        case RuleOperator.LessThan: opString = "less"; break;
        ...
        /// <returns></returns>
        public static Group DeserializeGroupFromJSON(string jsonString)
        {
        ...
        protected static Group DeserializeGroupFromJSON(JToken value)
        {
            Group g = new Group();
        ...
        protected static Rule DeserializeRuleFromJSON(JToken value)
        {
            Rule r = new Rule();
